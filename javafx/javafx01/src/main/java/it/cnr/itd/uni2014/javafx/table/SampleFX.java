package it.cnr.itd.uni2014.javafx.table;
...
public class SampleFX extends Application {
	...
	private final ObservableList<Person> data = FXCollections
			.observableArrayList(
					new Person("Jacob", "Smith", "jacob.smith_at_example.com",
							"js_at_example.com"),
					new Person("Isabella", "Johnson",
							"isabella.johnson_at_example.com",
							"ij_at_example.com"),
					new Person("Ethan", "Williams",
							"ethan.williams_at_example.com",
							"ew_at_example.com"),
					new Person("Emma", "Jones", "emma.jones_at_example.com",
							"ej_at_example.com"),
					new Person("Michael", "Brown",
							"michael.brown_at_example.com", "mb_at_example.com"));
		...
		secondaryEmailCol
				.setOnEditCommit(new EventHandler<CellEditEvent<Person, String>>() {
					...
					public void handle(CellEditEvent<Person, String> t) {
						((Person) t.getTableView().getItems()
								.get(t.getTablePosition().getRow()))
								.setSecondaryEmail(t.getNewValue());
					}
				});
