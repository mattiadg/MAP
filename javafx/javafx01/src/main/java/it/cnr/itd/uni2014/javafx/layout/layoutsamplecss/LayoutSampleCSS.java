package it.cnr.itd.uni2014.javafx.layout.layoutsamplecss;
...
public class LayoutSampleCSS extends Application {
	...
	public void start(Stage stage) {
		...
		scene.getStylesheets().add("layout/layoutsamplecss/layoutstyles.css");
	...
	private HBox addHBox() {
		...
		// Use style class to set properties previously set above (with some
		// changes)
	...
	private GridPane addGridPane() {
		...
		// Use style classes to set properties previously set above (with some
		// changes)
	...
	private FlowPane addFlowPane() {
		...
		for (int i = 0; i < 8; i++) {
			pages[i] = new ImageView(new Image(
					LayoutSampleCSS.class.getResourceAsStream("graphics/chart_"
							+ (i + 1) + ".png")));
