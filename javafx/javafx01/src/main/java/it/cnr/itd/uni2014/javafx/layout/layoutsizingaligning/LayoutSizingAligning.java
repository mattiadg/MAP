package it.cnr.itd.uni2014.javafx.layout.layoutsizingaligning;
...
public class LayoutSizingAligning extends Application {
	...
	private Pane sizingSample() {
		...
		ObservableList<String> items = FXCollections.observableArrayList(
				"Hot dog", "Hamburger", "French fries", "Carrot sticks",
				"Chicken salad");
	...
	/*
	 * Creates the UI for the alignment sample, which demonstrates ways to
	 * manage the alignment of controls when you don't want the default
	 * alignment.
	 */
	...
	private VBox createButtonColumn() {
		...
		vbButtons.getChildren().addAll(btnAdd, btnDelete, btnMoveUp,
				btnMoveDown);
		return vbButtons;
	}
